...
pedestrians, or leave the intersections as normal - in other words, as changing
...
Once Python, matplotlib, and NumPy are installed, you can simply enter the
\textit{code} subdirectory and run the
