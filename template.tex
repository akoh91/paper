...
In this initial project checkpoint, we utilize a pre-existing random number
generator. However, for our final simulation model, we intend to use the simple
linear congruential approach to create our own generator. This generator is
given a \textit{seed} value, and then produces a uniformly distributed
pseudorandom number. This value is then used to sample from a given probability
distribution.
